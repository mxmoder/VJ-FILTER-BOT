...
URL = "https://mxmoder.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mxmoder.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mxmoder.onrender.com/".format(FQDN)
else:
    URL = "https://mxmoder.onrender.com/".format(FQDN)
